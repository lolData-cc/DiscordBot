...
export async function execute(interaction) {
  ...
  const embed = new EmbedBuilder().setColor("#01D38E").setDescription(
    ...
    "```ansi\n[2;40m[2;32m How do I earn exp points on lolData's discord server? [0m\n```\n" +
    "You can earn exp points by winning giveaways, chatting with other community members and being active in the server.\n\n" +
    "```ansi\n[2;40m[2;32m How do I check how many points I have? [0m\n```\n" +
    ...
    "```ansi\n[2;40m[2;32m How do I check the Leaderboard? [0m\n```\n" +
    ...
    "```ansi\n[2;40m[2;32m How do I check all the available commands? [0m\n```\n" +
    ...
    "```ansi\n[2;40m[2;32m How do I become a partner? [0m\n```\n" +
    ...
    "```ansi\n[2;40m[2;32m Where can I read informations on this project? [0m\n```\n" +
